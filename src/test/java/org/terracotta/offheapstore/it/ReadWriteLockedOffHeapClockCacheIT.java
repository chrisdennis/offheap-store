...
public class ReadWriteLockedOffHeapClockCacheIT extends AbstractConcurrentOffHeapMapIT {
  ...
  public ReadWriteLockedOffHeapClockCacheIT(Generator generator) {
    super(generator);
  }
  ...
  protected ConcurrentMap<SpecialInteger, SpecialInteger> createMap(Generator generator) {
    return new ReadWriteLockedOffHeapClockCache<SpecialInteger, SpecialInteger>(new UnlimitedPageSource(new OffHeapBufferSource()), generator.engine(), 1);
  }
